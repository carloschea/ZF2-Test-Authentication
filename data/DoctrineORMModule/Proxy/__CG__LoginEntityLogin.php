 ...
 */
class Login extends \Login\Entity\Login implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Login\\Entity\\Login' . "\0" . 'id', '' . "\0" . 'Login\\Entity\\Login' . "\0" . 'login', '' . "\0" . 'Login\\Entity\\Login' . "\0" . 'senha');
        }
